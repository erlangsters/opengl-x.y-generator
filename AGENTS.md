...
- The `populate-binding-*.sh` scripts assume this repository sits next to the target clones in the `graphics-stack` workspace. They write scratch `gl.erl`, `gl.hrl`, and `gl.c` in the generator root before copying.
- Supported OTP is 28.
